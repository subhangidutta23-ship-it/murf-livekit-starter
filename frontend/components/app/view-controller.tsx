...
export function ViewController({ appConfig }: ViewControllerProps) {
  ...
  return (
    <div className="relative w-full h-full min-h-svh flex items-center justify-center bg-gradient-to-br from-slate-100 via-sky-50/80 to-blue-100/90 text-slate-900 overflow-hidden">
