...
export function DisasterAvatar({
  ...
  const statusColors = {
    ready: {
      ...
      bgGrad: 'from-slate-900 via-slate-800 to-sky-950',
    },
    connecting: {
      visor: '#f59e0b', // Amber
      core: '#d97706',
      ...
      bgGrad: 'from-amber-950 via-slate-900 to-amber-900',
    },
    listening: {
      visor: '#3b82f6', // Blue
      core: '#2563eb',
      ...
      bgGrad: 'from-blue-950 via-slate-900 to-blue-900',
    },
    speaking: {
      ...
      bgGrad: 'from-emerald-950 via-slate-900 to-emerald-900',
    },
    ended: {
      visor: '#64748b', // Slate
      core: '#475569',
      ...
      bgGrad: 'from-slate-900 via-slate-900 to-slate-950',
    },
    error: {
      visor: '#ef4444', // Red
      core: '#dc2626',
      ...
      bgGrad: 'from-red-950 via-slate-900 to-red-900',
    },
  };
  ...
  return (
    <div className={cn('relative flex items-center justify-center', className)}>
      ...
      <div
        className={cn(
          'relative z-10 flex flex-col items-center justify-center rounded-3xl border-2 transition-all duration-300 shadow-2xl p-2 backdrop-blur-md',
          sizeClasses[size],
          current.border,
          current.glow,
      ...
      >
        ...
        >
          {/* Antenna */}
          <line x1="50" y1="12" x2="50" y2="24" stroke="#94a3b8" strokeWidth="4" strokeLinecap="round" />
          <circle
            cx="50"
            cy="10"
            r="4"
          ...
          <rect x="18" y="38" width="8" height="18" rx="4" fill="#475569" />
          <rect x="74" y="38" width="8" height="18" rx="4" fill="#475569" />
          ...
          {isListening && (
            <>
              ...
              <line x1="34" y1="45" x2="66" y2="45" stroke="#60a5fa" strokeWidth="1" strokeDasharray="2 2" />
            </>
          )}
          ...
          {state === 'ended' && (
            <>
              {/* Sleeping Eyes */}
              <path d="M 36 45 Q 40 48 44 45" stroke="#64748b" strokeWidth="2" strokeLinecap="round" fill="none" />
              <path d="M 56 45 Q 60 48 64 45" stroke="#64748b" strokeWidth="2" strokeLinecap="round" fill="none" />
            </>
          )}
          ...
          {/* Neck Joint */}
          <rect x="42" y="68" width="16" height="8" rx="2" fill="#334155" />
        ...
        <div className="absolute -bottom-2 bg-slate-950 border border-slate-700 px-2 py-0.5 rounded-full shadow-md text-[10px] font-mono font-bold tracking-widest text-slate-200 uppercase flex items-center gap-1">
          <span className={cn('w-1.5 h-1.5 rounded-full inline-block', isSpeaking ? 'bg-emerald-400 animate-ping' : isListening ? 'bg-blue-400' : isConnecting ? 'bg-amber-400' : 'bg-sky-400')} />
          SENTINEL
        </div>
      </div>
    </div>
