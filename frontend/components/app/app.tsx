...
export function App({ appConfig }: { appConfig?: any }) {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-slate-50 via-sky-50/50 to-blue-50 text-slate-900 font-sans flex flex-col items-center justify-between p-6">
      ...
      {/* Top Header Bar */}
      <header className="w-full max-w-4xl flex items-center justify-between py-4 px-6 bg-white/80 backdrop-blur-md rounded-2xl border border-slate-200/80 shadow-sm">
        <div className="flex items-center space-x-3">
          <div className="p-2 bg-sky-100 rounded-xl border border-sky-200 text-sky-700">
          ...
          <div>
            ...
            <p className="text-[11px] font-mono text-slate-500 uppercase tracking-wider">
              National Emergency Command Relay
            </p>
          </div>
        </div>
